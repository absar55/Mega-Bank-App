...
$apply1 = filter_input(INPUT_POST, 'apply1');
...
?>
        <section>
            ...
            <form method="POST" enctype="multipart/form-data" action="Debit_Card.php">
                <input type="hidden" name="apply1" value="1">
...
?>
        ...
        <section>
            ...
            <button onclick="deactivateDebitCard()">Deactivate Debit Card</button>
            <button class="activate-btn" onclick="activateDebitCard()">Activate Debit Card</button>
        </section>
        <?php
...
?>
    ...
    function generateRandomDebitCard() {
        var storedCardNumber = localStorage.getItem('cardNumber1');
        ...
        if (storedCardNumber && storedExpiryDate && storedCvv && storedCardHolderName) {
            document.getElementById('cardNumber1').textContent = storedCardNumber;
            ...
            var cardNumber1 = Math.floor(Math.random() * 10000 + 1000) + ' ' + Math.floor(Math.random() * 10000 +
                    1000) +
            ...
            document.getElementById('cardNumber1').textContent = cardNumber1;
    ...
    generateRandomDebitCard();

    function deactivateDebitCard() {
    ...
    function activateDebitCard() {
        ...
        alert('Debit card activated successfully!');
    }
    </script>
</body>
